...
public class EmailService {
    ...
    @KafkaListener(topics = "otp-topic", groupId = "notification-group", containerFactory = "otpListenerFactory")
    public void sendForgotPasswordOtp(OtpEvent otpEvent) {
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(otpEvent.getEmail());
        message.setSubject("Mã OTP đặt lại mật khẩu");
        message.setText(
                "Xin chào,\n\n" +
                        "Bạn đã yêu cầu đặt lại mật khẩu.\n" +
                        "Mã OTP của bạn là: " + otpEvent.getOtpCode() + "\n" +
